...
describe("Utils Module - Debugging and Conversion Utilities", () => {
	describe("inspect()", () => {
		...
		it("should handle different value types in callbacks", () => {
			...
			const onOk = (value: unknown) => values.push(value);
			const onErr = (error: unknown) => errors.push(error);
	...
	describe("tap()", () => {
		...
		it("should work for side effects like logging", () => {
			const logs: string[] = [];
			const logger = (value: unknown) => logs.push(`Processed: ${value}`);
		...
		it("should work for side effects like caching", () => {
			...
			const cacheValue = (value: { id: string; data: unknown }) => {
	...
	describe("tapErr()", () => {
		...
		it("should work for error logging", () => {
			...
			const errorLogger = (error: unknown) => errorLogs.push(`Error: ${error}`);
		...
		it("should handle different error types", () => {
			const errors: unknown[] = [];
			const collector = (error: unknown) => errors.push(error);
	...
	describe("toNullable()", () => {
		...
		it("should work with complex Result chains", () => {
			const processData = (input: string): Result<number, string> => {
				...
				if (Number.isNaN(num)) return err("Not a number");
	...
	describe("Integration Tests", () => {
		...
		it("should work with real-world API patterns", () => {
			...
			const fetchUserData = (id: number): Result<unknown, string> => {
